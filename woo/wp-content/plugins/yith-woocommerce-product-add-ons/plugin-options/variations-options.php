...
$variations = array(
	...
	'variations'  => array(
		...
		array(
			...
			'title'     => __( 'Enable plugin on archive pages', 'yith-woocommerce-product-add-ons' ),
			'type'      => 'checkbox',
			'desc'      => __( 'Allow attribute selection on archive shop pages', 'yith-woocommerce-product-add-ons' ),
			'default'   => 'yes'
		),
		...
		array(
			...
			'desc'      => __( 'Show add-ons on archive shop pages', 'yith-woocommerce-product-add-ons' ),
			'type'      => 'select',
			'options'   => array(
		...
		array(
			...
			'type'      => 'text',
			'desc'      => __( '"Add to cart" button label on archive pages (for variable products only)', 'yith-woocommerce-product-add-ons' ),
