...
$general = array(
	...
	'general'  => array(
		...
		array(
			...
			'type'		=> 'text',
			'desc'		=> __( 'Set the format of the date control E.g.', 'yith-woocommerce-product-add-ons' ) . ': mm/dd/yy',
		...
		*/
		...
		array(
			...
			'desc'		=> __( 'Select this option if the add-ons don\'t appear in the cart using a custom layout.', 'yith-woocommerce-product-add-ons' ),
			'default' 	=> 'no',
		),
		array(
			...
			'desc'		=> __( 'Select this option if the add-ons don\'t appear on 7up themes product page', 'yith-woocommerce-product-add-ons' ),
			'default' 	=> 'no',
		),
