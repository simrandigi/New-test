...
<div class="title"><span class="icon"></span> <?php echo __( 'TEXTAREA', 'yith-woocommerce-product-add-ons' ); ?> - <?php echo $addon->get_option( 'label', $x ); ?></div>
...
<div class="fields">
	...
	<!--
	<div class="field-wrap">
		<label for="option-advanced-editor"><?php echo __( 'Advanced editor', 'yith-woocommerce-product-add-ons' ); ?></label>
		<div class="field">
			<?php yith_plugin_fw_get_field( array(
