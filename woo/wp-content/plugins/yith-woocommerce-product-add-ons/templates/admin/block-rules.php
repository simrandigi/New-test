...
$show_show_in_products = $show_in != 'categories' && $show_in != 'all';
$show_show_in_categories = $show_in == 'categories';

$show_exclude_products = $show_in == 'all' || $show_in == 'categories';
$show_exclude_products_products = $block->get_rule('exclude_products') == 'yes' && ( $show_in == 'all' || $show_in == 'categories' );
$show_exclude_products_categories = $block->get_rule('exclude_products') == 'yes' && $show_in == 'all';
...
<div id="block-rules" style="display: none;">
	...
	<div class="field-wrap">
		<label for="yith-wapo-block-rule-show-in"><?php echo __( 'Show this block of options in', 'yith-woocommerce-product-add-ons' ); ?>:</label>
		<div class="field">
			<?php
				yith_plugin_fw_get_field( array(
					...
					'options'	=> array(
						...
						// 'categories'	=> __( 'Products of specific categories', 'yith-woocommerce-product-add-ons' ),
					),
				), true );
			?>
			<span class="description"><?php echo __( 'Choose to show these options in all products or only specific products or categories.', 'yith-woocommerce-product-add-ons' ); ?></span>
		</div>
	</div>
	<!-- End option field -->
	...
	<div class="field-wrap yith-wapo-block-rule-show-in-products" style="<?php echo $show_show_in_products ? '' : 'display: none;'; ?>">
		<label for="yith-wapo-block-rule-show-in-products"><?php echo __( 'Products to include', 'yith-woocommerce-product-add-ons' ); ?>:</label>
		<div class="field">
			<?php
				yith_plugin_fw_get_field( array(
			...
			?>
			<span class="description"><?php echo __( 'Choose in which products to show this block.', 'yith-woocommerce-product-add-ons' ); ?></span>
		</div>
	</div>
	<!-- End option field -->
	...
	<!-- Option field -->
	<div class="field-wrap yith-wapo-block-rule-show-in-products" style="<?php echo $show_show_in_products ? '' : 'display: none;'; ?>">
		<label for="yith-wapo-block-rule-show-in-categories"><?php echo __( 'Categories to include', 'yith-woocommerce-product-add-ons' ); ?>:</label>
		<div class="field">
			<?php
				yith_plugin_fw_get_field( array(
			...
			?>
			<span class="description"><?php echo __( 'Choose in which product categories to show this block.', 'yith-woocommerce-product-add-ons' ); ?></span>
		</div>
	</div>
	<!-- End option field -->
	...
	<?php if ( defined( 'YITH_WAPO_PREMIUM' ) && YITH_WAPO_PREMIUM ) : ?>
		...
		<div class="field-wrap yith-wapo-block-rule-exclude-products" style="<?php echo $show_exclude_products ? '' : 'display: none;'; ?>">
			<label for="yith-wapo-block-rule-exclude-products"><?php echo __( 'Exclude products', 'yith-woocommerce-product-add-ons' ); ?>:</label>
			<div class="field">
				<?php
					yith_plugin_fw_get_field( array(
				...
				?>
				<span class="description"><?php echo __( 'Enable if you want to hide these options in some products.', 'yith-woocommerce-product-add-ons' ); ?></span>
			</div>
		</div>
		<!-- End option field -->
		...
		<div class="field-wrap yith-wapo-block-rule-exclude-products-products" style="<?php echo $show_exclude_products_products ? '' : 'display: none;'; ?>">
			<label for="yith-wapo-block-rule-exclude-products-products"><?php echo __( 'Products to exclude', 'yith-woocommerce-product-add-ons' ); ?>:</label>
			<div class="field">
				<?php
					yith_plugin_fw_get_field( array(
				...
				?>
				<span class="description"><?php echo __( 'Choose the products to exclude.', 'yith-woocommerce-product-add-ons' ); ?></span>
			</div>
		</div>
		<!-- End option field -->
		...
		<div class="field-wrap yith-wapo-block-rule-exclude-products-categories" style="<?php echo $show_exclude_products_categories ? '' : 'display: none;'; ?>">
			<label for="yith-wapo-block-rule-exclude-products-categories"><?php echo __( 'Categories to exclude', 'yith-woocommerce-product-add-ons' ); ?>:</label>
			<div class="field">
				<?php
					yith_plugin_fw_get_field( array(
				...
				?>
				<span class="description"><?php echo __( 'Choose the categories to exclude.', 'yith-woocommerce-product-add-ons' ); ?></span>
			</div>
		</div>
		<!-- End option field -->
		...
		<!-- Option field -->
		<div class="field-wrap">
			<label for="yith-wapo-block-rule-show-to"><?php echo __( 'Show options to', 'yith-woocommerce-product-add-ons' ); ?>:</label>
			<div class="field">
				<?php
					global $wp_roles;
				...
				?>
				<span class="description"><?php echo __( 'Choose to show these options to all users, or only to specific user roles or members of a membership plan.', 'yith-woocommerce-product-add-ons' ); ?></span>
			</div>
		</div>
		<!-- End option field -->
		...
		<div class="field-wrap yith-wapo-block-rule-show-to-user-roles" style="<?php echo $block->get_rule('show_to') == 'user_roles' ? '' : 'display: none;'; ?>">
			<label><?php echo __( 'User roles', 'yith-woocommerce-product-add-ons' ); ?>:</label>
			<div class="field">
				<?php
				yith_plugin_fw_get_field( array(
		...
		<?php if ( function_exists( 'yith_wcmbs_get_plans' ) ) : ?>
			...
			<div class="field-wrap yith-wapo-block-rule-show-to-membership" style="<?php echo $block->get_rule('show_to') == 'membership' ? '' : 'display: none;'; ?>">
				<label><?php echo __( 'Membership plan', 'yith-woocommerce-product-add-ons' ); ?>:</label>
				<div class="field">
					<?php
					yith_plugin_fw_get_field( array(
