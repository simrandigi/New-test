...
<div id="tab-style-settings" style="display: none;">
	...
	<div class="field-wrap">
		<label for="addon-custom-style"><?php echo __( 'Override default style for this set of labels', 'yith-woocommerce-product-add-ons' ); ?></label>
		<div class="field">
	...
	<!-- Option field -->
	<div class="field-wrap enabled-by-addon-custom-style" style="display: none;">
		<label><?php echo __( 'Content alignment', 'yith-woocommerce-product-add-ons' ); ?></label>
		<div class="field">
			<?php
			yith_plugin_fw_get_field( array(
	...
	<div class="field-wrap addon-image-equal-height enabled-by-addon-custom-style" style="display: none;">
		<label for="addon-image-equal-height"><?php echo __( 'Force image equal heights', 'yith-woocommerce-product-add-ons' ); ?></label>
		<div class="field">
			<?php yith_plugin_fw_get_field( array(
	...
	<div class="field-wrap enabled-by-addon-image-equal-height" style="display: none;">
		<label for="addon-images-height"><?php echo __( 'Image heights', 'yith-woocommerce-product-add-ons' ); ?> (px)</label>
		<div class="field">
			<?php yith_plugin_fw_get_field( array(
	...
	<!-- Option field -->
	<div class="field-wrap enabled-by-addon-custom-style" style="display: none;">
		<label><?php echo __( 'Label position', 'yith-woocommerce-product-add-ons' ); ?></label>
		<div class="field">
			<?php
			yith_plugin_fw_get_field( array(
	...
	<!-- Option field -->
	<div class="field-wrap enabled-by-addon-custom-style" style="display: none;">
		<label><?php echo __( 'Description position', 'yith-woocommerce-product-add-ons' ); ?></label>
		<div class="field">
			<?php
			yith_plugin_fw_get_field( array(
	...
	<!-- Option field -->
	<div class="field-wrap enabled-by-addon-custom-style" style="display: none;">
		<label for="addon-label-padding"><?php echo __( 'Padding', 'yith-woocommerce-product-add-ons' ); ?> (px)</label>
		<div class="field">
			<?php
			$label_padding_array = $addon->get_setting('label_padding', array(
					'dimensions' => array(
						'top' => 10,
						'right' => 10,
						'bottom' => 10,
