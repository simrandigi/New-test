...
echo sprintf( '%s<input id="%s" placeholder="%s" data-typeid="%s" data-price_x="%s" data-price="%s" data-pricetype="%s" data-index="%s" type="%s" name="%s[%s]" value="%s" %s class="%s" %s %s %s %s %s %s />%s',
	$before_label,
	$control_id,
	$placeholder,
	esc_attr( $type_id ),
