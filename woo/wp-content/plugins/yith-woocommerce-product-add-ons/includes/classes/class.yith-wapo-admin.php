	...
	class YITH_WAPO_Admin {
		...
		function addon_options_template( $options ) {
			...
			<div class="sold_individually">
				...
				<span class="woocommerce-help-tip" data-tip="<?php _e( 'Check this box, if you want the selected add-ons not to increase if the product quantity changes.', 'yith-woocommerce-product-add-ons' ); //@since 1.1.0 ?>"></span>
				<strong>(<?php _e( 'premium', 'yith-woocommerce-product-add-ons' ); ?>)</strong>
			</div>
			...
			<div class="calculate_quantity_sum">
				...
				<span class="woocommerce-help-tip" data-tip="<?php _e( 'Check this box, if you want that the quantity input will be updated with the sum of all add-ons values.', 'yith-woocommerce-product-add-ons' ); //@since 1.1.0 ?>"></span>
				<strong>(<?php _e( 'premium', 'yith-woocommerce-product-add-ons' ); ?>)</strong>
			</div>
			<div class="required">
				<input type="checkbox" disabled="disabled">
				<?php echo __( 'Required', 'yith-woocommerce-product-add-ons' ); ?>
				<span class="woocommerce-help-tip" data-tip="<?php _e( 'Check this option if you want the add-ons to be selected', 'yith-woocommerce-product-add-ons' ); //@since 1.1.3 ?>"></span>
				<strong>(<?php _e( 'premium', 'yith-woocommerce-product-add-ons' ); ?>)</strong>
			</div>
            <div class="required_all_options">
                <input type="checkbox" disabled="disabled">
				<?php echo __( 'All options required', 'yith-woocommerce-product-add-ons' ); ?>
				<span class="woocommerce-help-tip" data-tip="<?php _e( 'Check this option if you want that the add-ons have all options required.', 'yith-woocommerce-product-add-ons' ); //@since 1.1.3 ?>"></span>
				<strong>(<?php _e( 'premium', 'yith-woocommerce-product-add-ons' ); ?>)</strong>
            </div>
            <div class="collapsed">
                <input type="checkbox" disabled="disabled">
